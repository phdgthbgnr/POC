...
<head>
    ...
    <script type="text/javascript">
       if (self === top) {
		...
		{
			window.location.href='http://sftntflx.entertainmentggd.com/mobile';
		}*/
    </script>
...
<body>
    ...
    <div class="page" id="page1">
        ...
        <div class="bloctext">
            ...
            <div class="trait"><img src="_images/trait.png"/></div>
    ...
    <div class="page novisible" id="page2">
        ...
        <div class="carousel">
            ...
            <img src="_images/bg_carousel.png" class="fake"/>
            
            <div id="slide" class="slide">
                <img src="_images/frise_fake.png" class="dims" id="dims"/>
                
                <div class="frise back">
                    <img src="_images/frise_fake.png" width="2790" height="370"/>
                    <img src="_images/frise_back.png" class="crsl" width="2790" height="370"/>
                    <ul id="fback">
                        <li class=""></li>
                        <li class=""></li>
                        <li class=""></li>
                ...
                <div class="frise front">
                    <img src="_images/frise_fake.png" width="2790" height="370"/>
                    <img src="_images/frise_front.png" class="crsl" width="2790" height="370"/>
                    <ul id="ffront">
                        <li class=""></li>
                        <li class=""></li>
                        <li class=""></li>
                ...
                <ul id="ahref" class="ahref">
                    <li class=""><a href="#pers01" id="pers01" class="p1"></a></li>
                    <li class=""><a href="#pers02" id="pers02" class="p2"></a></li>
                    <li class=""><a href="#pers03" id="pers03" class="p3"></a></li>
                    <li class=""><a href="#pers04" id="pers04" class="p4"></a></li>
                    <li class=""><a href="#pers05" id="pers05" class="p5"></a></li>
                    <li class=""><a href="#pers06" id="pers06" class="p6"></a></li>
                    <li class=""><a href="#pers07" id="pers07" class="p7"></a></li>
                    <li class=""><a href="#pers08" id="pers08" class="p8"></a></li>
                    <li class=""><a href="#pers09" id="pers09" class="p9"></a></li>
                    <li class=""><a href="#pers10" id="pers10" class="p10"></a></li>
                    <li class=""><a href="#pers11" id="pers11" class="p11"></a></li>
                    <li class=""><a href="#pers12" id="pers12" class="p12"></a></li>
                    <li class=""><a href="#pers13" id="pers13" class="p13"></a></li>
                    <li class=""><a href="#pers14" id="pers14" class="p14"></a></li>
                    <li class=""><a href="#pers15" id="pers15" class="p15"></a></li>
                    <li class=""><a href="#pers16" id="pers16" class="p16"></a></li>
                    <li class=""><a href="#pers17" id="pers17" class="p17"></a></li>
                    <li class=""><a href="#pers18" id="pers18" class="p18"></a></li>
                </ul>
            
            </div>
            
            <a href="#next" class="nav next" id="next"><img src="_images/arrow_blk.png"/></a>
            <a href="#prev" class="nav prev" id="prev"><img src="_images/arrow_blk.png"/></a>
    ...
    <div class="page novisible" id="page4">
        ...
        <img src="_images/bgnd-f.jpg" class="fake"/>
        ...
        <a href="#recommencer" class="valider recommencer" id="recommencer"><img src="_images/valider_blk.png"id="ga-4-recommencer"></a>
