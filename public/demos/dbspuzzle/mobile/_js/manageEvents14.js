...
var manageEvents = {
    ...
    listenerAdd: function(id, evt, callback, capture, c, t){
        var elem = id !== window && id !== document && (id != '[object HTMLImageElement]' && Object.prototype.toString.call(id) != '[object HTMLAnchorElement]' && Object.prototype.toString.call(id) != '[object HTMLLIElement]') ? this.$dc(id) : id;
        try{
    ...
    addAclass: function (id, classe){
        ...
        node.classList ?  node.classList.add(classe) :  node.className += ' '+classe;
    },
