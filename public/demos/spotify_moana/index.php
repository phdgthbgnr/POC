...
$og['nz'] = $og['ie'] = $og['uk'] = $og['au'] = $og['mys'] = $og['idn'] = $og['sgp'] = $og['phl'] = $og['us'];
...
$hosts = array(
    ...
    'nz.moana-spotify.com'     => array('lang' => 'nz', 'rep' => 'nz', 'code' => 'en', 'moana' => 1),      // nouvelle zelande
...
<head>
    ...
    <link rel="stylesheet" href="_img/<?php echo $rep ?>/style.min.css">

    <style type="text/css">
        .boathml,.logohml{position:absolute}.interhtml{z-index:100;background:#0c537e}.animhml,.animhml div{position:absolute;top:0;bottom:0;right:0;left:0;animation-fill-mode:both;background-repeat:no-repeat;overflow:hidden}.bghml{width:100%;height:100%;background-image:url(_media/bg.jpg);background-size:cover}.bghml img,.boathml img,.seahml img,.skyhml img{width:100%;height:auto}.logohml{top:3%!important;right:0!important;width:30%;max-width:540px;left:auto!important;bottom:auto!important;height:auto;-webkit-animation:animlogo .5s ease-in-out .7s;animation:animlogo .5s ease-in-out .7s}.logohml img{width:100%;height:auto}.boathml{bottom:0;left:10%;width:100%;height:auto}.boathml img,.seahml{left:0;position:absolute}.boathml img{bottom:-35%;display:block;width:100%;-webkit-animation:animboat 1.5s cubic-bezier(.68,1,.48,1) 1s forwards;animation:animboat 1.5s cubic-bezier(.68,1,.48,1) 1s forwards;opacity:0}.seahml{overflow:hidden;bottom:0;width:auto;height:100%;-webkit-animation:animsea 1.5s ease-in-out .2s;animation:animsea 1.5s ease-in-out .2s}.seahml img{width:100%;position:absolute;bottom:-35%}.skyhml,.skyhml img{width:auto;height:100%}.skyhml{-webkit-animation:animsky .5s ease-in-out .2s;animation:animsky .5s ease-in-out .2s}@-webkit-keyframes animlogo{0%{opacity:0}100%{opacity:1}}@keyframes animlogo{0%{opacity:0}100%{opacity:1}}@-webkit-keyframes animsky{0%{opacity:0;-webkit-transform:translateX(0)}100%{opacity:1;-webkit-transform:translateX(0)}}@keyframes animsky{0%{opacity:0;transform:translateX(0)}100%{opacity:1;transform:translateX(0)}}@-webkit-keyframes animboat{0%{-webkit-transform:translateX(-10%) translateY(5%);opacity:0}100%{-webkit-transform:translateX(0) translateY(0);opacity:1}}@keyframes animboat{0%{transform:translateX(-10%) translateY(5%);opacity:0}100%{transform:translateX(0) translateY(0);opacity:1}}@keyframes animsea{0%{transform:translateY(10%);opacity:0}100%{transform:translateY(0);opacity:1}}@-webkit-keyframes animsea{0%{-webkit-transform:translateY(10%);opacity:0}100%{-webkit-transform:translateY(0);opacity:1}}@media screen and (max-width:1024px){.bghml{width:100%;height:100%;background-image:url(_media/mob/bg.jpg);background-size:cover}}
	</style>
...
<body>
   ...
   (function(){
       ...
       */
       ...
       var urlspotify=window.urlspt,lang=window.lang,urlfb=window.urlfb,rep=window.rep,moana=window.moana,request=!1,autoplay=!0,curTracks=0,totTracks=0,curSongId=0,audioTag,albums=window.albums,assets=window.assets,voyages=window.voyages,msgsoon=window.msgsoon,mobile=parseInt(window.mobile),lang,tmap,map1,map2,hmap=1,initmouseX=0,initmouseY=0,offsetx=0,offsety=0,oldoffsetx=0,oldoffsety=0,xmap=4470,xmap2=2235,_htmap=1079,diffx=0,diffy=0,zmax=1.4,zmin=.7,_zoom=.02,_timer,curbtsimg=0,mapenable=!0,imgload=0,interzoom=null,started=0,ochanged=0,currentnode="",$ID=function(e){var s=null;return null!==document.getElementById(e)&&(s=document.getElementById(e)),null==s&&console.log('%cERREUR : id "'+e+'" introuvable',"color:#ff1d00;font-weight:bold"),s},addAclass=function(e,s){$ID(e).classList?$ID(e).classList.add(s):$ID(e).className+=" "+s},removeAclass=function(e,s){$ID(e).className=$ID(e).className.replace(" "+s,"").replace(s,"")},hasAclass=function(e,s){var t=$ID(e);return(" "+t.className+" ").indexOf(" "+s+" ")>-1},afterVoyage=function(){addAclass("interhtml","nodisplay"),finintervideo()},getVoyages=function(){if(0==voyages.length)return!0;for(var e=0;e<voyages.length;e++){if("yt"==voyages[e].type&&0==voyages[e].dejavu)return window.player1.loadVideoById(voyages[e].id),voyages[e].dejavu=1,removeAclass("intervideo","nodisplay"),startlevelTimer(300,5e3,afterMinuterie),!1;if("html"==voyages[e].type&&0==voyages[e].dejavu)return voyages[e].dejavu=1,removeAclass("interhtml","nodisplay"),startlevelTimer(300,3500,afterVoyage),!1}return!0},getPoster=function(e){for(var s="posterblnk.gif",t=0;t<albums.length;t++)albums[t].album==e&&(s=albums[t].poster);return s},getAlbum=function(e,s,t){var a=getPoster(t);if($ID("posters").src="_img/"+rep+"/posters/"+a,""!==e){var l="https://embed.spotify.com/?uri=spotify:album:"+e+"&view=list",n='<iframe id="theframe" src="'+l+'" width="380" height="300" frameborder="0" allowtransparency="true"></iframe>';"#moana"==s&&"0"===moana&&(n+='<div class="pastille"><img src="_img/'+rep+'/pastille.png"/></div>'),$ID("album").innerHTML=n}else $ID("album").innerHTML='<div class="pastille"><img src="_img/'+rep+'/pastille.png"/></div>';return!1},getScalefromZoom=function(){var e=window.getComputedStyle(tmap,null),s=e.getPropertyValue("transform");if(null!==s){var t=s.split("(")[1];t=t.split(")")[0],t=t.split(",");var a=parseInt(t[4]),l=parseInt(t[5]);0!=a&&(oldoffsetx=a),0!=l&&(oldoffsety=l)}},stoplevelTimer=function(){clearInterval(_timer)},startlevelTimer=function(e,s,t){var a=e/s*100,l=$ID("minuterie"),n=0,i=t;_timer=setInterval(function(){n+=a,n>100&&(n=100),l.style.width=n+"%",100==n&&(i(),stoplevelTimer())},e)},finintervideo=function(){window.player1.stopVideo();var e=$ID("skip").getAttribute("data-album"),s=$ID("skip").getAttribute("data-ref"),t=$ID("skip").getAttribute("data-num");autoplay=!0,getAlbum(e,s,t),addAclass("intervideo","nodisplay"),addAclass("moana3","moanafanim")},finBTSvideo=function(e){addAclass("btsvideo","nodisplay"),removeAclass("blocg","novisible"),removeAclass("blocd","novisible"),removeAclass("soon","novisible"),e&&(removeAclass("close1","novisible"),removeAclass("closevid","novisible"),addAclass("skipbts","novisible"),removeAclass("share1","novisible"))},refreshMap=function(){var e=tmap.getBoundingClientRect();return e.width/2<window.innerWidth?(manageEvents.listenerRemove("contmap","mousemove",!0),manageEvents.listenerRemove("contmap","touchmove",!0),oldoffsety=offsety=(window.innerHeight-_htmap)/2,oldoffsetx=offsetx=(window.innerWidth-xmap2*hmap)/2,tmap.style.transform="translate("+offsetx+"px, "+offsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+offsetx+"px, "+offsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+offsetx+"px, "+offsety+"px) scale("+hmap+")",addAclass("mapb","novisible"),!1):(removeAclass("mapb","novisible"),e.left>=0?(oldoffsetx=offsetx=oldoffsetx-xmap2*hmap,tmap.style.transform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",!0):e.right<=window.innerWidth?(oldoffsetx=offsetx=oldoffsetx+xmap2*hmap,oldoffsetx=offsetx-10,tmap.style.transform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",!0):!1)},initMaps=function(e,s){var t=$ID(e).getBoundingClientRect(),a=(map1.getBoundingClientRect(),$ID(e).offsetTop),l=$ID(e).offsetLeft,n=$ID(e).parentNode.getAttribute("id");addAclass("twomaps","transmap"),manageEvents.listenertransAdd("twomaps","transitionend",s);var i="mapb"==n?xmap2:0;map1.style.left="0px",map2.style.left=xmap2+"px",window.innerWidth>1024&&(hmap=.9),window.innerWidth<=1024&&window.innerWidth>700&&(zmin=.5,hmap=.7),window.innerWidth<=700&&(zmin=.4,hmap=.6),oldoffsetx=offsetx=-(l+i)*hmap+window.innerWidth/2-t.width/2*hmap,oldoffsety=offsety=(_htmap*hmap-_htmap)/2-(a*hmap-window.innerHeight/2),tmap.style.transform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")"},movemap=function(e,s,t){if(!mapenable)return!1;refreshMap();var a,l,n=tmap.getBoundingClientRect();if(n.width<window.innerWidth)return manageEvents.listenerRemove("contmap","touchmove",!0),manageEvents.listenerRemove("contmap","mousemove",!0),!1;var i=n.left,o=n.right;return e.changedTouches&&e.touches.length>1?(manageEvents.listenerRemove("contmap","touchmove",!0),!1):e.changedTouches&&e.touches.length>2?(manageEvents.listenerRemove("contmap","touchmove",!0),!1):(e.changedTouches&&1==e.touches.length&&0>i&&(a=e.changedTouches[0].clientX,l=e.changedTouches[0].clientY,offsetx=a-initmouseX+oldoffsetx,offsety=l-initmouseY+oldoffsety,tmap.style.transform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")"),!e.changedTouches&&(0>=i||o>window.innerWidth)&&(a=void 0===e.x?e.clientX:e.x,l=void 0===e.y?e.clientY:e.y,offsetx=a-initmouseX+oldoffsetx,offsety=l-initmouseY+oldoffsety,tmap.style.transform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")"),!1)},handlezoom=function(e,s,t){if(e.changedTouches&&e.touches.length>1){var a=e.touches[0].clientX,l=e.touches[1].clientX,n=e.touches[0].clientY,i=e.touches[1].clientY,o=Math.abs(a-l),r=Math.abs(n-i);o>diffx&&r>diffy&&(hmap+=_zoom),diffx>o&&diffy>r&&(hmap-=_zoom),hmap=hmap>zmax?zmax:hmap,hmap=zmin>hmap?zmin:hmap,tmap.style.transform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",getScalefromZoom(),refreshMap(),diffx=o,diffy=r}return!1},handletouchstart=function(e,s,t){if(mapenable=!0,hasAclass("instruct","nodisplay")||addAclass("instruct","nodisplay"),e.changedTouches&&2==e.touches.length){var a=e.touches[0].clientX,l=e.touches[1].clientX,n=e.touches[0].clientY,i=e.touches[1].clientY;return diffx=Math.abs(a-l),diffy=Math.abs(n-i),manageEvents.listenerRemove("contmap","touchmove",!0),manageEvents.listenerAdd("contmap","touchmove",handlezoom,!0),!1}if(e.changedTouches&&e.touches.length>2)return!1;var o,r;return e.changedTouches&&1==e.touches.length&&(o=e.changedTouches[0].clientX,r=e.changedTouches[0].clientY,manageEvents.listenerAdd("contmap","touchmove",movemap,!0),initmouseX=o,initmouseY=r,tmap.style.transform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")"),!1},mousehdown=function(e,s,t){var a,l;hasAclass("instruct","nodisplay")||addAclass("instruct","nodisplay"),e.changedTouches||(a=void 0===e.x?e.clientX:e.x,l=void 0===e.y?e.clientY:e.y);var n=tmap.getBoundingClientRect();return n.width/2<window.innerWidth&&n.height<window.innerHeight?(initmouseX=a,initmouseY=l,mapenable=!0,!1):(mapenable=!0,initmouseX=a,initmouseY=l,tmap.style.transform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",manageEvents.listenerAdd("contmap","mousemove",movemap,!0),!1)},handleup=function(e,s,t){return mapenable=!1,manageEvents.listenerRemove("contmap","mousemove",!0),manageEvents.listenerRemove("contmap","touchmove",!0),e.changedTouches&&e.touches.length>1?!1:(diffx=diffy=0,oldoffsetx=offsetx,oldoffsety=offsety,centerVertical(),!1)},centerVertical=function(){var e=tmap.getBoundingClientRect();return e.height<window.innerHeight?(oldoffsety=offsety=(window.innerHeight-_htmap)/2,addAclass("twomaps","transmapb"),manageEvents.listenertransAdd("twomaps","transitionend",transend2),tmap.style.transform="translate("+oldoffsetx+"px, "+offsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+oldoffsetx+"px, "+offsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+oldoffsetx+"px, "+offsety+"px) scale("+hmap+")",!1):(e.top>0&&(oldoffsety=offsety=(_htmap*hmap-_htmap)/2,addAclass("twomaps","transmapb"),manageEvents.listenertransAdd("twomaps","transitionend",transend2),tmap.style.transform="translate("+oldoffsetx+"px, "+offsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+oldoffsetx+"px, "+offsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+oldoffsetx+"px, "+offsety+"px) scale("+hmap+")"),void(e.bottom<window.innerHeight&&(oldoffsety=offsety=window.innerHeight-(_htmap*hmap+_htmap)/2,addAclass("twomaps","transmapb"),manageEvents.listenertransAdd("twomaps","transitionend",transend2),tmap.style.transform="translate("+oldoffsetx+"px, "+offsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+oldoffsetx+"px, "+offsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+oldoffsetx+"px, "+offsety+"px) scale("+hmap+")")))},manualZoomd=function(e,s,t){hasAclass("instruct","nodisplay")||addAclass("instruct","nodisplay");var a=s.getAttribute("id");return interzoom=setInterval(function(){hmap="zplus"==a?hmap+_zoom:hmap-_zoom,hmap=hmap>zmax?zmax:hmap,hmap=zmin>hmap?zmin:hmap,tmap.style.transform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",getScalefromZoom()},100),!1},manualZoomu=function(e,s,t){return refreshMap(),clearInterval(interzoom),!1},wheelMouse=function(e,s,t){hasAclass("instruct","nodisplay")||addAclass("instruct","nodisplay");var a=Math.max(-1,Math.min(1,e.deltaY));-1==a&&(hmap+=.1),1==a&&(hmap-=.1),hmap=hmap>zmax?zmax:hmap,hmap=zmin>hmap?zmin:hmap,tmap.style.transform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+oldoffsetx+"px,"+oldoffsety+"px) scale("+hmap+")",getScalefromZoom(),refreshMap()},reSize=function(e,s,t){initSlider(),1==started&&refreshMap()},afterMinuterie=function(){addAclass("minutes","fadeout"),addAclass("skip","fadein")},transend=function(e,s,t){removeAclass("twomaps","transmap"),removeAclass("instruct","instzero"),addAclass("mapa","vawes"),addAclass("mapb","vawes"),manageEvents.listenerRemove("twomaps","transitionend")},transend2=function(e,s,t){removeAclass("twomaps","transmapb"),manageEvents.listenerRemove("twomaps","transitionend")},transend3=function(e,s,t){removeAclass("twomaps","transmap"),refreshMap(),centerVertical(),addAclass("mapa","vawes"),addAclass("mapb","vawes"),manageEvents.listenerRemove("twomaps","transitionend")},clicthmb=function(e,s,t){var a=s.getAttribute("href"),l=s.getAttribute("data-type");switch(l){case"images":$ID("affiche").src="_img/"+lang+"/bts/big/"+a+".jpg";break;case"youtube":removeAclass("btsvideo","nodisplay"),window.player2.loadVideoById(a),addAclass("blocg","novisible"),addAclass("blocd","novisible"),addAclass("soon","novisible");break;case"playlist":}return!1},displayBTS=function(e,s){var t='<ul id="sliding">',a=0==e?"lite/":1==e?"thumbvid/":"thumbplst/",l=0==e?"trois":1==e?"deux":"trois",n=0==e?"images":1==e?"youtube":"playlist",i="";removeAclass("thimg","sel"),removeAclass("thvideo","sel"),removeAclass("thplst","sel");var o="";0==e&&(addAclass("thimg","sel"),i="ga-thimg-"),1==e&&(addAclass("thvideo","sel"),i="ga-thvideo-",o='<img src="_img/arrow-video.png" class="arrow"/>'),2==e&&(addAclass("thplst","sel"),i="ga-thplst-");for(var r=0;r<assets[e].asset.length;r++){var d=assets[e].asset[r],m="";2==e&&(m=urlspotify),t+='<li class="'+l+'"><a href="'+m+d+'" id="thmb'+r+'" data-type="'+n+'" target="_blank">'+o+'<img src="_img/'+lang+"/bts/"+a+d+'.jpg" id="'+i+(r+1)+'" class="fond"/></a></li>'}t+="</ul>",$ID("thumb").innerHTML='<div class="liste" id="liste">'+t+'<div id="gutter" class="gutter novisible"><div class="slider" id="slider"></div></div></div>';for(var r=0;r<assets[e].asset.length;r++)2==e?manageEvents.listenerAdd("thmb"+r,"click",clicthmb,!1):manageEvents.listenerAdd("thmb"+r,"click",clicthmb,!0);s&&(removeAclass("btsvideo","nodisplay"),window.player2.loadVideoById(assets[e].asset[0]),addAclass("blocg","novisible"),addAclass("blocd","novisible"),addAclass("close1","novisible"),addAclass("closevid","novisible"),removeAclass("skipbts","novisible"),addAclass("share1","novisible"),addAclass("soon","novisible"));setTimeout(function(){initSlider()},800)},clicnothing=function(e,s,t){return!1},clic=function(e,s,t){var a="";try{a=s.getAttribute("href")}catch(l){a=""}if(""!==a)switch(a){case"#start":started=1;for(var n=1;16>n;n++){var i="film"+n+"a",o="film"+n+"b";removeAclass(i,"opaczero"),removeAclass(o,"opaczero")}removeAclass("boat1","opaczero"),removeAclass("boat2","opaczero"),removeAclass("footermap1","novisible"),removeAclass("behind","novisible"),removeAclass("socials","novisible"),removeAclass("zooms","novisible"),addAclass("page1","novisible"),removeAclass("mapa","novisible"),removeAclass("mapb","novisible"),addAclass("loader","nodisplay"),initMaps("film11a",transend);break;case"#behind":addAclass("behind","novisible"),addAclass("footermap1","novisible"),""!=assets[1].asset[0]?displayBTS(1,!0):""!=assets[2].asset[0]&&(displayBTS(2,!1),addAclass("skipbts","novisible")),removeAclass("page7","novisible"),addAclass("moana2","moanafanim"),removeAclass("mapa","vawes"),removeAclass("mapb","vawes"),addAclass("zooms","novisible"),removeAclass("mapa","vawes"),removeAclass("mapb","vawes");break;case"#images":displayBTS(0,!1);break;case"#videos":displayBTS(1,!1);break;case"#playlists":displayBTS(2,!1);break;case"#closevideo":window.player2.stopVideo(),removeAclass("blocg","novisible"),removeAclass("blocd","novisible"),addAclass("btsvideo","nodisplay"),removeAclass("soon","novisible");break;case"#suiv":curbtsimg<assets[0].asset.length-1&&(curbtsimg++,$ID("affiche").src="_img/"+lang+"/bts/big/"+assets[0].asset[curbtsimg]+".jpg");break;case"#prec":curbtsimg>0&&(curbtsimg--,$ID("affiche").src="_img/"+lang+"/bts/big/"+assets[0].asset[curbtsimg]+".jpg");break;case"#continue1":$ID("thumb").innerHTML="",addAclass("page7","novisible"),removeAclass("footermap1","novisible"),removeAclass("behind","novisible"),removeAclass("blocg","novisible"),removeAclass("blocd","novisible"),window.player2.pauseVideo(),addAclass("btsvideo","nodisplay"),removeAclass("moana2","moanafanim"),addAclass("mapa","vawes"),addAclass("mapb","vawes"),removeAclass("zooms","novisible"),addAclass("mapa","vawes"),addAclass("mapb","vawes");break;case"#continue2":$ID("album").innerHTML="",addAclass("albums","novisible"),$ID("posters").src="_img/loading.gif",removeAclass("footermap1","novisible"),removeAclass("behind","novisible"),removeAclass("moana3","moanafanim"),removeAclass("zooms","novisible"),initMaps(currentnode,transend3);break;case"#skip":finintervideo();break;case"#skipbts":finBTSvideo(!0),window.player2.pauseVideo()}return!1},clicfilms=function(e,s,t){mapenable=!1,manageEvents.listenerRemove("contmap","mousemove",!0),manageEvents.listenerRemove("contmap","touchmove",!0);var a,l;if(!e.changedTouches&&(a=void 0===e.x?e.clientX:e.x,l=void 0===e.y?e.clientY:e.y,a!=initmouseX||l!=initmouseY))return!1;if(e.changedTouches&&(a=e.changedTouches[0].clientX,l=e.changedTouches[0].clientY,Math.abs(a-initmouseX)>10||Math.abs(l-initmouseY)>10))return diffx=diffy=0,oldoffsetx=offsetx,oldoffsety=offsety,!1;var n="";try{n=s.getAttribute("href")}catch(i){n=""}if(""!==n)switch(n){case"#peterpan":case"#cinderella":case"#frozen":case"#tangled":case"#mermaid":case"#pinocchio":case"#aladdin":case"#mulan":case"#lionking":case"#junglebook":case"#moana":case"#pocahontas":case"#bighero6":case"#baymax":case"#frog":removeAclass("mapa","vawes"),removeAclass("mapb","vawes"),autoplay=getVoyages(),curTracks=0,curSongId=0;var o=s.getAttribute("data-num"),r=s.getAttribute("id"),d=s.getAttribute("data-album");$ID("skip").setAttribute("data-album",d),$ID("skip").setAttribute("data-ref",n),$ID("skip").setAttribute("data-num",o),addAclass("footermap1","novisible"),addAclass("behind","novisible"),addAclass("zooms","novisible"),removeAclass("albums","novisible");var m=s.getAttribute("data-bx"),c=s.getAttribute("data-by");$ID("boat1").style.top=c+"%",$ID("boat1").style.left=m+"%",$ID("boat2").style.top=c+"%",$ID("boat2").style.left=m+"%",autoplay&&addAclass("moana3","moanafanim"),getAlbum(d,n,o),currentnode=r}return!1},imgloaded=function(e,s,t,a,l){if(imgload++,$ID("loading").style.width=Math.round(imgload/l*100)+"%",imgload>=l)var n=setTimeout(function(){addAclass("loader","nodisplay"),clearTimeout(n)},1e3)},slider={touchstarty:0,boundlist:{},contH:0,lsty:0,lstH:0,gutY:0,gutH:0,slY:0,slH:0,ulY:0,ulH:0,offY:0,lineH:0,offYd:0,deltalist:0},initSlider=function(){if(null!==$ID("sliding")){var e=$ID("sliding").childNodes.length;slider.contH=$ID("liste").offsetHeight,slider.lstH=$ID("liste").childNodes[0].offsetHeight,slider.gutH=$ID("gutter").offsetHeight,slider.ulY=$ID("sliding").offsetTop,slider.ulH=$ID("sliding").offsetHeight,slider.lineH=$ID("sliding").childNodes[0].offsetHeight,slider.offY=slider.ulH/e,slider.boundlist=$ID("liste").getBoundingClientRect(),slider.offYd=slider.offY/2,slider.deltalist=slider.ulH-slider.contH,slider.slH=slider.deltalist,$ID("sliding").style.transform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.transform="translate(0px,"+slider.ulY+"px)",$ID("sliding").style.msTransform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.msTransform="translate(0px,"+slider.ulY+"px)",$ID("sliding").style.WebkitTransform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.WebkitTransform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.height=slider.gutH-slider.slH+"px",slider.deltalist<=0?addAclass("gutter","novisible"):removeAclass("gutter","novisible"),slider.contH<slider.lstH?(manageEvents.listenerAdd("liste","touchstart",slidetouchstart,!1),manageEvents.listenerAdd("liste","mousewheel",slidewheelMouse,!0),manageEvents.listenerAdd("liste","DOMMouseScroll",slidewheelMouse,!0),manageEvents.listenerAdd("liste","wheel",slidewheelMouse,!0),removeAclass("gutter","novisible")):(manageEvents.listenerRemove("liste","touchstart"),manageEvents.listenerRemove("liste","mousewheel"),manageEvents.listenerRemove("liste","DOMMouseScroll"),manageEvents.listenerRemove("liste","wheel"),hasAclass("gutter","novisible")||addAclass("gutter","novisible"))}},slidetouchstart=function(e,s,t){return slider.touchstarty=e.touches[0].clientY,manageEvents.listenerAdd("liste","touchmove",slidetouchmove,!0),manageEvents.listenerAdd("liste","touchend",slidetouchend,!1),manageEvents.listenerAdd("liste","touchleave",slidetouchend,!1),!1},slidetouchmove=function(e,s,t){var a=$ID("sliding").getBoundingClientRect().top,l=$ID("sliding").getBoundingClientRect().bottom;return e.touches[0].clientY<slider.touchstarty&&l>slider.boundlist.bottom&&(slider.ulY-=slider.offYd,$ID("sliding").style.transform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.transform="translate(0px,"+-slider.ulY+"px)"),e.touches[0].clientY>slider.touchstarty&&a<slider.boundlist.top&&(slider.ulY+=slider.offYd,$ID("sliding").style.transform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.transform="translate(0px,"+-slider.ulY+"px)"),a>slider.boundlist.top&&(slider.ulY=0,$ID("sliding").style.transform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.transform="translate(0px,"+-slider.ulY+"px)"),slider.touchstarty=e.touches[0].clientY,!1},slidetouchend=function(e,s,t){manageEvents.listenerRemove("liste","touchmove"),manageEvents.listenerRemove("liste","touchend"),manageEvents.listenerRemove("liste","touchleave")},slidewheelMouse=function(e,s,t){var a=Math.max(-1,Math.min(1,e.deltaY)),l=$ID("sliding").getBoundingClientRect().top,n=$ID("sliding").getBoundingClientRect().bottom;return-1==a&&l>slider.boundlist.top?(slider.ulY=0,$ID("sliding").style.transform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.transform="translate(0px,"+-slider.ulY+"px)",$ID("sliding").style.msTransform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.msTransform="translate(0px,"+-slider.ulY+"px)",$ID("sliding").style.WebkitTransform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.WebkitTransform="translate(0px,"+-slider.ulY+"px)",!1):1==a&&n<=slider.boundlist.bottom-slider.offYd?(slider.ulY=-slider.deltalist,$ID("sliding").style.transform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.transform="translate(0px,"+-slider.ulY+"px)",$ID("sliding").style.msTransform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.msTransform="translate(0px,"+-slider.ulY+"px)",$ID("sliding").style.WebkitTransform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.WebkitTransform="translate(0px,"+-slider.ulY+"px)",!1):(1==a&&n>=slider.boundlist.bottom&&(slider.ulY-=slider.offYd,$ID("sliding").style.transform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.transform="translate(0px,"+-slider.ulY+"px)",$ID("sliding").style.msTransform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.msTransform="translate(0px,"+-slider.ulY+"px)",$ID("sliding").style.WebkitTransform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.WebkitTransform="translate(0px,"+-slider.ulY+"px)"),-1==a&&l<slider.boundlist.top&&(slider.ulY+=slider.offYd,$ID("sliding").style.transform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.transform="translate(0px,"+-slider.ulY+"px)",$ID("sliding").style.msTransform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.msTransform="translate(0px,"+-slider.ulY+"px)",$ID("sliding").style.WebkitTransform="translate(0px,"+slider.ulY+"px)",$ID("slider").style.WebkitTransform="translate(0px,"+-slider.ulY+"px)"),!1)},shareFB=function(e,s,t){var a=600,l=400,s=window.innerHeight/2-l/2,n=window.innerWidth/2-a/2;return window.open(urlfb,"facebook","width=600, height=400, top="+s+", left="+n+" scrollbars=no"),!1};manageEvents.listenerAdd(window,"orientationchange",function(e,s,t){if(0==started&&window.innerWidth>window.innerHeight&&0==ochanged){tmap=$ID("twomaps"),map1=$ID("mapa"),map2=$ID("mapb"),map1.style.top="0px",map2.style.top="0px",map1.style.left="0px",map2.style.left=xmap2+"px";var a=$ID("film11a").getBoundingClientRect(),l=map1.getBoundingClientRect();oldoffsetx=offsetx=(window.innerWidth/2-a.left)*hmap-a.width/2,oldoffsety=offsety=-(a.top+l.top)*hmap+window.innerHeight/2,hmap=1.2,tmap.style.transform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",ochanged=1}window.player1.pauseVideo(),window.player2.pauseVideo();var n=s.orientation;if(void 0!==n){setTimeout(function(){var e=window.innerWidth,s=screen.width,t=screen.height,a=window.innerHeight;if(e>a){t>s&&(t=s);document.body.style.height=t+"px",setTimeout(function(){window.scrollTo(0,0)},10)}},300)}}),manageEvents.listenerAdd(document,"DOMContentLoaded",function(e,s,t){if(manageEvents.ImageLoader.listenerAdd("img","load",imgloaded,!0),tmap=$ID("twomaps"),map1=$ID("mapa"),map2=$ID("mapb"),manageEvents.listenerAdd("contmap","touchstart",handletouchstart,!0),manageEvents.listenerAdd("contmap","mousedown",mousehdown,!0),manageEvents.listenerAdd("contmap","touchend",handleup,!1),manageEvents.listenerAdd("contmap","mouseup",handleup,!0),manageEvents.listenerAdd("contmap","mousewheel",wheelMouse,!1),manageEvents.listenerAdd("contmap","DOMMouseScroll",wheelMouse,!1),manageEvents.listenerAdd("contmap","wheel",wheelMouse,!1),manageEvents.listenerAdd(window,"resize",reSize,!0),manageEvents.listenerAdd("start","click",clic,!0),manageEvents.listenerAdd("behind","click",clic,!0),manageEvents.listenerAdd("thimg","click",clic,!0),manageEvents.listenerAdd("thvideo","click",clic,!0),manageEvents.listenerAdd("thplst","click",clic,!0),manageEvents.listenerAdd("prec","click",clic,!0),manageEvents.listenerAdd("suiv","click",clic,!0),manageEvents.listenerAdd("close1","click",clic,!0),manageEvents.listenerAdd("continue2","click",clic,!0),manageEvents.listenerAdd("close2","click",clic,!0),manageEvents.listenerAdd("closevid","click",clic,!0),manageEvents.listenerAdd("skip","click",clic,!0),manageEvents.listenerAdd("skipbts","click",clic,!0),manageEvents.listenerAdd("zplus","click",clicnothing,!0),manageEvents.listenerAdd("zmin","click",clicnothing,!0),manageEvents.listenerAdd("zplus","mousedown",manualZoomd,!0),manageEvents.listenerAdd("zmin","mousedown",manualZoomd,!0),manageEvents.listenerAdd("zplus","touchstart",manualZoomd,!0),manageEvents.listenerAdd("zmin","touchstart",manualZoomd,!0),manageEvents.listenerAdd("zplus","mouseup",manualZoomu,!0),manageEvents.listenerAdd("zmin","mouseup",manualZoomu,!0),manageEvents.listenerAdd("zplus","touchend",manualZoomu,!0),manageEvents.listenerAdd("zmin","touchend",manualZoomu,!0),manageEvents.listenerAdd("share1","click",shareFB,!0),manageEvents.listenerAdd("share2","click",shareFB,!0),manageEvents.listenerAdd("share3","click",shareFB,!0),window.innerWidth>window.innerHeight){var a=$ID("film11a").getBoundingClientRect(),l=map1.getBoundingClientRect();map1.style.left="0px",map2.style.left=xmap2+"px",oldoffsetx=offsetx=(window.innerWidth/2-a.left)*hmap-a.width/2,oldoffsety=offsety=-(a.top+l.top)*hmap+window.innerHeight/2,hmap=1.2,tmap.style.transform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",tmap.style.msTransform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",tmap.style.WebkitTransform="translate("+offsetx+"px,"+offsety+"px) scale("+hmap+")",ochanged=1}for(var n=1;16>n;n++){var i="film"+n+"a",o="film"+n+"b";manageEvents.listenerAdd(i,"click",clicfilms,!0),manageEvents.listenerAdd(o,"click",clicfilms,!0),manageEvents.listenerAdd(i,"touchend",clicfilms,!0),manageEvents.listenerAdd(o,"touchend",clicfilms,!0)}},!0),window.startlevelTimer=startlevelTimer,window.afterMinuterie=afterMinuterie,window.finintervideo=finintervideo,window.finBTSvideo=finBTSvideo,window.albums=null,window.assets=null,window.lang=null,window.urlspt=null,window.voyages=null,window.msgsoon=null,window.urlfb=null,window.rep=null,window.moana=null;
       // end closure
    })();
