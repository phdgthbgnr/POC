var howtoState = {
    ...
    preload:function(){
        ...
        game.load.image('texte1', game.pathText+'mouse-left-right-1.png');
        game.load.image('texte2', game.pathText+'selecttwo-1.png');
        game.load.image('texte3', game.pathText+'findsall-1.png');

        game.load.spritesheet('gotit', '_img/got-it.png', 203, 52);
        game.load.spritesheet('icon1',game.pathImg+'png/icone-mouse.png', Math.round(380*game.mratio), Math.round(74*game.mratio));
        game.load.spritesheet('icon2',game.pathImg+'png/icone-cards.png', Math.round(386*game.mratio), Math.round(112*game.mratio));
        game.load.spritesheet('icon3',game.pathImg+'png/icone-timer.png', Math.round(380*game.mratio), Math.round(74*game.mratio));

        game.load.image('tracking03', game.pathTrack+'pixel.gif?r=howto');
