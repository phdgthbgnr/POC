...
(function(m,t,r,s,mbl,pnk,ipd){
    ...
    var sending = false,
        ...
        // ajout bg
            ...
            scontext.clearRect(0, 0, 1200, 630);
            scontext.restore();
            shareimg.src = '_img/blnkequipe.gif';
            var bimg = new Image();
            bimg.src = repjoueurcnvs + 'bg_share.jpg';
            deferImageCanvas(loadInCanvasPlayer, 0 , bimg, 0, 0, 1200, 630, 0, 0, 1200, 630);
        // loadInCanvasPlayer();
        },
        ...
        //scontext.save();
            ...
            if(indCanvas == nbJoueurs-1){
                var st = setTimeout(function(){
                    var data = scanvas.toDataURL('image/jpeg',.7);
...
}(manageEvents, window.token, window.refreshjson, window.semaine, window.ismobil, window.panik, window.isipad));