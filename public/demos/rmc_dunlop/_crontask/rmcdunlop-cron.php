...
<?php
  ...
  // chemain de la commande CRON : rmcdunlop/_inc/rmcdunlop-cron.php
...
if(empty($lastid)){
  $getfield = '?q=%23lapureeamere&result_type=recent&count=7';
}else{
  $getfield = '?q=%23lapureeamere&result_type=recent&count=7&since_id='.$lastid;
