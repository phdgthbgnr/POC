...
(function () {
    ...
    */
    ...
    document.addEventListener('DOMContentLoaded', function(){
                        ...
                        if(response2){
                            DZ.api('/playlist/'+idPlaylist, function(response3){
                                if(response3.error === undefined){
                                    ...
                                    document.getElementById('gdz').href = 'http://www.deezer.com/playlist/' + idPlaylist;
                                }
                            });
                        }
                    });
        ...
        shareFBplst = function(){
            FB.ui({
                  method: 'feed',
                  name: 'Ma playlist Feelunique',
                  link: 'http://www.deezer.com/playlist/'+idPlaylist,
                  description: 'Je viens de composer ma playlist',
                  caption: 'Feel Unique'
              },function(d){
                  // nothing
              });
